...
export const addCollectionAndDocuments = async (collectionKey, objectsToAdd,) => {
  ...
  // store each objectsToAdd into collectionRef as a new document 
  // transaction - successful unit of work to database. can contain multiple processes eg transfering money accross accounts
  // use a batch to add all objects to collection in one successful transaction
